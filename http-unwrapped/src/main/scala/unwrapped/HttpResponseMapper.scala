...
object HttpResponseMapper:
  ...
  given HttpResponseReceiveMapper: HttpResponseMapper[unwrapped.Receive[Byte]] =
    new HttpResponseMapper[unwrapped.Receive[Byte]] {
      def bodyHandler: BodyHandler[unwrapped.Receive[Byte]] = BodyHandlers.buffering(
        new BodyHandler[unwrapped.Receive[Byte]] {
          def apply(responseInfo: HttpResponse.ResponseInfo)
              : HttpResponse.BodySubscriber[unwrapped.Receive[Byte]] =
            new HttpResponse.BodySubscriber[unwrapped.Receive[Byte]] {
              val debug = false
              ...
              def getBody(): CompletionStage[unwrapped.Receive[Byte]] =
