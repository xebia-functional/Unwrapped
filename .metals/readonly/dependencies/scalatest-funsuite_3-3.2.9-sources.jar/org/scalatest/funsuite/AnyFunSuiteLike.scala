...
inline def registerTest(testText: String, testTags: Tag*)(testFun: => Any /* Assertion */)(implicit pos: source.Position): Unit = {
  ${ source.Position.withPosition[Unit]('{(pos: source.Position) => registerTestImpl(testText, testTags: _*)(testFun, pos) }) } 
}
...
inline def registerIgnoredTest(testText: String, testTags: Tag*)(testFun: => Any /* Assertion */)(implicit pos: source.Position): Unit = {
  ${ source.Position.withPosition[Unit]('{(pos: source.Position) => registerIgnoredTestImpl(testText, testTags: _*)(testFun, pos) }) } 
}
...
inline def test(testName: String, testTags: Tag*)(testFun: => Any /* Assertion */): Unit = {
  ...
  /**
    ...
    * @throws NotAllowedException if <code>testName</code> had been registered previously
    */
inline def ignore(testName: String, testTags: Tag*)(testFun: => Any /* Assertion */): Unit = {
  ${ source.Position.withPosition[Unit]('{(pos: source.Position) => ignoreImpl(testName, testTags: _*)(testFun, pos) }) } 
}
