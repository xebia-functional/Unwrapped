...
class ScalaFxAssertionsSuite extends ScalaCheckSuite, ScalaFxAssertions:
  ...
  property(
    "given a true condition, assertFX should return a Raise[AssertionError] ?=> Unit that evaluates to `()` run") {
    forAll { (cond: Boolean) =>
  ...
  property(
    "given a false condition, assertFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to a `FailException` when run.") {
    forAll { (cond: Boolean) =>
      !cond ==> {
  ...
  property(
    "given two equal items, assertEqualFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to `()` when run") {
    forAll { (givenInt: Int) =>
  ...
  property(
    "given two unequal items, assertEqualFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to a ComparisonFailure when run") {
    forAll { (x: Int, y: Int) =>
      (x != y) ==> {
        val obtained =
  ...
  property(
    "given a false condition, assumeFX should return a `Raise[AssumptionViolatedException]` ?=> Unit that evaluates to an AssumptionViolatedException when run") {
    forAll { (cond: Boolean) =>
      (!cond) ==> {
  ...
  property(
    "given a true condition, assumeFX should return a `Raise[AssumptionViolatedException] ?=> Unit` that evaluates to () when run") {
    forAll { (cond: Boolean) =>
      cond ==> {
        val obtained = run(assumeFX(cond))
        obtained match
  ...
  property(
    "when given two equal strings, assertNoDiffFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to () when run") {
    forAll { (s: String) =>
  ...
  property(
    "when given two nonequal strings, assertNoDiffFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to a ComparisonFailureException when run") {
  ...
  property(
    "given two equal items, assertNotEqualFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to a ComparisonFailure when run") {
    forAll { (givenInt: Int) =>
  ...
  property(
    "given two unequal items, assertEqualFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to `()` when run") {
    forAll { (x: Int, y: Int) =>
      (x != y) ==> {
        val obtained =
  ...
  property(
    "given two equal items, assertEqualsDoubleFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to `()` when run") {
  ...
  property(
    "given two items within a tolerance delta range of each other, assertEqualsDoubleFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to `()` when run") {
  ...
  property(
    "given two unequal items, assertEqualsDoubleFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to a ComparisonFailure when run") {
  ...
  property(
    "given two equal items, assertEqualsFloatFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to `()` when run") {
  ...
  property(
    "given two items within a tolerance delta range of each other, assertEqualsFloatFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to `()` when run") {
  ...
  property(
    "given two unequal items, assertEqualsFloatFX should return a `Raise[AssertionError] ?=> Unit` that evaluates to a ComparisonFailure when run") {
