...
private [continuations] val $continuationName = "$continuation"
private [continuations] val illegalArgumentExceptionFullName = "java.lang.IllegalArgumentException"
private [continuations] val resumeBeforeInvokeErrorMessage = "call to \'resume\' before \'invoke\' with coroutine"
private [continuations] val checkResultMethodName = "checkResult"
private [continuations] val stateMachineLabelPrefix = "label"
private [continuations] val safeContinuationName = "safeContinuation"
private [continuations] val safeContinuationClassName = s"$continuationPackageName.SafeContinuation"
private [continuations] val initMethodName = "init"
private [continuations] val getOrThrowMethodName = "getOrThrow"
private [continuations] val orThrowName = "orThrow"
